  ...
  const renderContent = () => (
    <div className="flex max-h-[70vh] flex-col">
      ...
      <div className="px-6 pt-4 text-center text-lg leading-tight font-medium">
        This model is Pro-only on ChatGPT
      </div>

      <div className="flex-grow overflow-y-auto">
        <div className="px-6 py-4">
          <p className="text-muted-foreground text-sm">
            ChatGPT is free and open-source. Some models require self-hosted
            access.
          </p>
          <p className="text-muted-foreground mt-1 text-sm">
            If you want to use this model, you can fork ChatGPT and add your own
